...
class AutoIncrementingTagStrategyTest extends PHPUnit_Framework_TestCase {
    ...
    public function test_it_can_bump_a_production_version() {
        ...
        $d->expectCommand('git --git-dir /var/www/test.fh.org/.git --work-tree /var/www/test.fh.org/. tag | grep -E -i "^3.0\.[0-9]+$" | sort -V | tail -1')
          ->andReturn('3.0.0');
        ...
        $expected = "Following strategy: Fh\Git\Deployment\Strategies\AutoIncrementingTagStrategy\n";
        $expected .= "command: git --git-dir /var/www/test.fh.org/.git --work-tree /var/www/test.fh.org/. tag | grep -E -i \"^3.0\.[0-9]+\$\" | sort -V | tail -1\n";
