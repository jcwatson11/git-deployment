 ...
 */
class StopDeploymentOnLocallyModifiedFileStrategy implements LocallyModifiedFileStrategyInterface {
    ...
    public function preDeploy(Deploy $deploy) {
        ...
        if($lmlist) {
            static::$bFoundLocallyModifiedFiles = TRUE;
            $deploy->out("Found locally modified files in target work area. Cannot continue with deployment.");
            return false;
        }
